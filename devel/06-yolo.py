...
class Masker:
    ...
    def __init__(self, detect_model_pth:str="yolo11m.pt", segment_model_pth:str="yolo11l-seg.pt", bot:ry.BotOp=None):
        self.bot = bot
...
if __name__ == "__main__":
    ...
    D = hack.DataPlayer(mask_blob, rgb)
